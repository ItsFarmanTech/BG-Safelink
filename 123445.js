document.addEventListener('DOMContentLoaded', function() {
    ...
    if (!isAllowedWebsite()) {
      ...
      document.getElementById(BGwid).style.textAlign = "-webkit-center";
        ...
        function continueProcess() {
            const currentIndex = sessionStorage.getItem('currentIndex') || 0;
  			function bgStep1() {
  				...
  				adBeforeBTN1.style.textAlign = "center";
  				adBeforeBTN1.innerHTML = adHBeforeBTN1;
  				var adAfterBTN1 = document.getElementById("adAfterBTN1");
  				adAfterBTN1.style.textAlign = "center";
  				adAfterBTN1.innerHTML = adHAfterBTN1;
                ...
                showButtonWithTimer(bgmainBTN1, 'Please Wait...', generateLinkTimer, () => {
                    ...
                    document.getElementById('generateLinkBtn').addEventListener('click', () => {
                        document.getElementById('bgMainBTN2').scrollIntoView({behavior: 'auto'});
  						...
  						adBeforeBTN2.style.textAlign = "center";
  						adBeforeBTN2.innerHTML = adHBeforeBTN2;
  						var adAfterBTN2 = document.getElementById("adAfterBTN2");
  						adAfterBTN2.style.textAlign = "center";
  						adAfterBTN2.innerHTML = adHAfterBTN2;
